...
% [wResult p] = graph_weighted('Matrix',adjacencymatrix,'regionLabels',regions,'PlotLocal',1,'PlotGlobal',...
%            `                       1, 'subjectmask',include, 'groups', groups, 'nRand', 100);
%
% ---------------------------- INPUT ----------------------------
%
...
PlotMatrices = p.Results.PlotMatrices; subjectmask = p.Results.subjectmask; percentage = p.Results.percentage;
